...
router.post('/api/get_billfish_pachanga_billfish_day_champion_pot_standings', getBillfishPachangaBillfishDayChampionPotStandings);
router.post('/api/get_billfish_pachanga_billfish_species_champion_pot_standings', getBillfishPachangaBillfishSpeciesChampionPotStandings);
router.post('/api/get_billfish_pachanga_meatfish_species_champion_pot_standings', getBillfishPachangaMeatfishSpeciesChampionPotStandings);
router.post('/api/get_billfish_pachanga_overall_billfish_non_sonar_pot_standings', getBillfishPachangaOverallBillfishNonSonarPotStandings);
router.post('/api/get_billfish_pachanga_captain_and_mate_pot_standings', getBillfishPachangaCaptainAndMatePotStandings);
